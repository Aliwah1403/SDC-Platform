...
export function generateStaticParams() { 
  return Promise.resolve(
    [{"slug":["account-deleted"]},{"slug":["admin-contact-notification"]},{"slug":["admin-waitlist-notification"]},{"slug":["beta-access"]},{"slug":["beta-claim"]},{"slug":["beta-invitation"]},{"slug":["email-change-confirmation"]},{"slug":["magic-link"]},{"slug":["password-reset-verification"]},{"slug":["signup-confirmation"]},{"slug":["user-invite"]},{"slug":["waitlist-email"]},{"slug":["waitlist-update"]}]
  );
}