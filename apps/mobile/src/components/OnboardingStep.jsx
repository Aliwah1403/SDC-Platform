...
export default function OnboardingStep({
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      {/* Top bar: progress dots + optional skip */}
            ...
            return (
              <View
                ...
                style={[
                  styles.dot,
                  isCurrent
                    ? [styles.dotCurrent, { backgroundColor: illustrationColor }]
                    : isPast
        ...
        >
          ...
          {IllustIcon && (
            <MotiView
              ...
              transition={{ type: 'spring', damping: 16, stiffness: 80, delay: 40 }}
              style={styles.illustrationArea}
            >
              <Svg style={StyleSheet.absoluteFill} viewBox="0 0 220 180">
                <Circle cx="110" cy="90" r="82" stroke={illustrationColor} strokeWidth="1" strokeOpacity={0.12} fill="none" />
                <Circle cx="110" cy="90" r="64" stroke={illustrationColor} strokeWidth="1" strokeOpacity={0.07} fill="none" />
                <Ellipse cx="175" cy="28" rx="38" ry="28" fill={illustrationColor} fillOpacity={0.07} />
                <Ellipse cx="38" cy="155" rx="28" ry="20" fill={illustrationColor} fillOpacity={0.06} />
              </Svg>
              <View style={[styles.illustCircle, { backgroundColor: `${illustrationColor}18`, borderColor: `${illustrationColor}22` }]}>
                <View style={[styles.illustInner, { backgroundColor: `${illustrationColor}12` }]}>
                  <IllustIcon size={48} color={illustrationColor} strokeWidth={1.5} />
                </View>
              </View>
            </MotiView>
          )}
          ...
          <MotiView
            ...
            transition={{ type: 'spring', damping: 18, stiffness: 80, delay: IllustIcon ? 120 : 60 }}
          ...
          <MotiView
            ...
            animate={{ opacity: 1, translateY: 0 }}
            transition={{ type: 'spring', damping: 18, stiffness: 80, delay: IllustIcon ? 200 : 140 }}
          >
            {children}
          </MotiView>
        </ScrollView>
