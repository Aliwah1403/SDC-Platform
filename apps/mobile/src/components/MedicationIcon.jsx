...
export function normalizeDoseForm(apiDoseForm = "") {
  ...
  if (f.includes("EFFERVESCENT")) return "effervescent";
  ...
  if (f.includes("SOLUTION") || f.includes("LIQUID") || f.includes("SYRUP"))
    return "liquid";
  return "tablet";
}
...
function TabletIcon({ color, size }) {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48">
      ...
      {/* Left half */}
      <Path
        d="M24 6 A18 18 0 0 0 24 42 Z"
        fill={color}
        clipPath="url(#tabletClip)"
      />
      {/* Right half */}
      <Path
        d="M24 6 A18 18 0 0 1 24 42 Z"
        fill={light}
        clipPath="url(#tabletClip)"
      />
      {/* Outer ring */}
...
function CapsuleIcon({ color, size }) {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48">
      ...
      <Path
        d="M24 16 H16 A8 8 0 0 0 8 24 A8 8 0 0 0 16 32 H24 Z"
        fill={color}
      />
      {/* Right dome — light */}
      <Path
        d="M24 16 H32 A8 8 0 0 1 40 24 A8 8 0 0 1 32 32 H24 Z"
        fill={light}
      />
      {/* Divider */}
      <Line
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48">
      ...
      <Ellipse
        ...
        ry="10"
        fill="none"
        stroke={lighten(color, 0.2)}
        strokeWidth="1.5"
      />
      {/* Sheen arc */}
      <Path
        d="M16 19 Q20 16 26 18"
        stroke="#fff"
        strokeWidth="2"
        strokeLinecap="round"
        strokeOpacity="0.55"
...
function LiquidIcon({ color, size }) {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48">
      ...
      {/* Liquid surface wave */}
      <Path
        d="M14 28 Q20 25 27 28 Q31 30 34 28"
