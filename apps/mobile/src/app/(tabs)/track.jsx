        ...
        {grid.map((item, i) => {
          ...
          return (
            <TouchableOpacity
              key={i}
              onPress={() => {
                if (!future && current) setSelectedDate(date);
              }}
              ...
              style={{
                ...
                opacity: !current ? 0 : future ? 0.3 : 1,
              }}
            >
              <View
                style={{
...
function ExpandableCalendar({
  ...
  return (
    <View>
      ...
      <TouchableOpacity
        onPress={toggle}
        style={{ alignItems: "center", paddingTop: 6, paddingBottom: 10 }}
      >
        <View
          style={{
            width: 36,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text
          style={{ fontFamily: fonts.semibold, fontSize: 13, color: "#fff" }}
        >
          Log Entry
        </Text>
      </TouchableOpacity>
...
const METRIC_CONFIGS = [
  {
    ...
    dataField: "painLevel",
    maxValue: 10,
    getValue: (e) => (e?.painLevel != null ? e.painLevel : null),
  },
  {
    key: "hydration",
    label: "Hydration",
    ...
    dataField: "hydration",
    maxValue: 16,
    getValue: (e) => (e?.hydration != null ? e.hydration : null),
  },
  {
    key: "mood",
    label: "Mood",
    ...
    dataField: "mood",
    maxValue: 5,
    getValue: (e) => (e?.mood != null ? e.mood : null),
  },
  {
    key: "steps",
    label: "Steps",
    ...
    dataField: "steps",
    maxValue: 15000,
    getValue: (e) => (e?.steps != null ? e.steps : null),
  },
  {
    key: "sleep",
    label: "Sleep",
    ...
    maxValue: 10,
    getValue: (e) =>
      e?.sleepHours != null ? Number(e.sleepHours.toFixed(1)) : null,
  },
  {
    key: "heartrate",
    label: "Heart Rate",
    ...
    dataField: "heartRate",
    maxValue: 120,
    getValue: (e) => (e?.heartRate != null ? e.heartRate : null),
  },
  {
    key: "spo2",
    label: "Blood Oxygen",
    ...
    dataField: "spO2",
    maxValue: 100,
    getValue: (e) => (e?.spO2 != null ? e.spO2 : null),
  },
  {
    key: "temperature",
    label: "Temperature",
    ...
    maxValue: 42,
    getValue: (e) => (e?.temperature != null ? e.temperature : null),
  },
  {
    key: "resprate",
    label: "Resp. Rate",
    ...
    maxValue: 30,
    getValue: (e) => (e?.respiratoryRate != null ? e.respiratoryRate : null),
  },
];

const METRIC_CONFIG_MAP = Object.fromEntries(
  ...
  switch (metricKey) {
    ...
    case "resprate":
      if (value >= 12 && value <= 20)
        return { label: "Normal", color: "#059669" };
      if (value > 20)
        return { label: "Elevated", color: value > 25 ? "#DC2626" : "#F59E0B" };
      return { label: "Low", color: "#F59E0B" };
    default:
      return null;
  }
...
function workoutStyle(activityType) {
  switch (activityType) {
    case 37:
      return { Icon: Activity, color: "#F0531C" }; // running
    case 52:
      return { Icon: Footprints, color: "#059669" }; // walking
    case 13:
      return { Icon: Activity, color: "#3B82F6" }; // cycling
    case 46:
      return { Icon: Waves, color: "#0EA5E9" }; // swimming
    case 24:
      return { Icon: Footprints, color: "#065F46" }; // hiking
    case 57:
    case 29:
      return { Icon: Wind, color: "#8B5CF6" }; // yoga / mind & body
    case 20:
    case 50:
    case 59:
      return { Icon: Activity, color: "#D97706" }; // strength / core
    case 33:
      return { Icon: Moon, color: "#6366F1" }; // recovery
    default:
...
function WorkoutItem({ workout, index, isLast }) {
  ...
  return (
    ...
    >
      ...
      {!isLast && (
        <View
          style={{ height: 1, backgroundColor: t.border, marginLeft: 72 }}
        />
      )}
    </MotiView>
  );
...
function HealthAlertCard({ alertState, onLogSymptoms }) {
  ...
  const triggerLabels = [
    ...new Set(alertState.triggers.map((tr) => tr.reason)),
  ].slice(0, 4);
...
export default function TrackScreen() {
  ...
  const loggedDates = useMemo(
    () => new Set(healthData.map((d) => d.date)),
    [healthData],
  );
