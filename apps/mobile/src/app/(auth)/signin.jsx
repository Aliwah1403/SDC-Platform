...
export default function SignInScreen() {
  ...
  useEffect(() => {
    ...
    AsyncStorage.getItem("lastAuthProvider").then((p) => { if (p) setLastProvider(p); });
  }, []);
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={{ flex: 1 }}>
        ...
        >
          ...
          >
            ...
            <Text style={[styles.subtitle, { color: c.textMuted }]}>Sign in to continue tracking your health</Text>
          </MotiView>
          ...
          >
            {/* Email */}
            <View style={[styles.inputWrapper, { backgroundColor: c.surface, borderColor: focusedField === 'email' ? '#A9334D' : c.border }, focusedField === 'email' && { backgroundColor: 'rgba(169,51,77,0.06)' }]}>
            ...
            {/* Password */}
            <View style={[styles.inputWrapper, { backgroundColor: c.surface, borderColor: focusedField === 'password' ? '#A9334D' : c.border }, focusedField === 'password' && { backgroundColor: 'rgba(169,51,77,0.06)' }]}>
...
const styles = StyleSheet.create({
  ...
  forgotText: { fontFamily: 'Geist_500Medium', fontSize: 13, color: '#A9334D' },
  ...
  lastUsedPill: {
    backgroundColor: 'rgba(169,51,77,0.12)', borderRadius: 8,
    borderWidth: 1, borderColor: 'rgba(169,51,77,0.35)',
    paddingHorizontal: 8, paddingVertical: 3,
  },
  lastUsedText: { fontFamily: 'Geist_500Medium', fontSize: 10, color: '#A9334D', letterSpacing: 0.3 },
});
