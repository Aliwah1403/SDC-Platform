...
export const easeOutStrong = Easing.bezier(0.23, 1, 0.32, 1); // entrances (reanimated)
export const easeInOutStrong = Easing.bezier(0.77, 0, 0.175, 1); // on-screen morphs (reanimated)
