  ...
  return (
    <div className="flex min-h-screen w-full flex-col overflow-x-hidden">
      ...
      <main className="flex flex-1 flex-col items-center justify-center px-6 pt-16 pb-24 text-center">
        ...
        >
          <Illustration className="w-48 text-[#A9334D] opacity-15 sm:w-64" />

          <h1 className="mt-8 max-w-lg text-balance text-5xl font-semibold tracking-[-0.03em] text-[#1A1A1A] sm:text-6xl">
            Page not found
          </h1>

          <p className="mt-5 max-w-md text-pretty text-lg text-muted-foreground">
            This page doesn't exist or may have been moved. Head back home or use the navigation above.
          </p>
          ...
          <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row">
            ...
            <Button
              size="lg"
              className="bg-[#A9334D] hover:bg-[#8a2940] text-white"
              onClick={() => navigate("/")}
            >
              Take me home
            </Button>
